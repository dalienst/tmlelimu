      ...
      <div className="flex-grow md:w-1/2 flex items-center justify-center p-8 bg-zinc-50">
        <div className="w-full max-w-md bg-white rounded-2xl border border-zinc-200 p-8 shadow-xl relative">
            ...
            <div className="flex flex-col gap-2">
              <div className="flex justify-between items-center">
                ...
                <Link
                  ...
                  className="text-[11px] font-bold text-[#004d40] hover:text-amber-600 transition-colors"
                >
                  Forgot password?
                </Link>
              </div>
                ...
                <input
                  ...
                  className={`w-full bg-white border ${
                    formik.touched.password && formik.errors.password
                      ? "border-red-500 focus:border-red-500"
                      : "border-zinc-200 focus:border-[#004d40]"
                  } rounded py-3 pl-11 pr-11 text-sm font-medium outline-none transition-all placeholder:text-zinc-400`}
                />
          ...
          <div className="mt-8 text-center border-t border-zinc-100 pt-6">
            <Link
              href="/"
              className="text-xs font-medium text-zinc-500 hover:text-[#004d40] transition-colors flex items-center justify-center gap-1"
            >
              ← Back to homepage
            </Link>
          </div>
